...
const CardDetails=()=>{
    ...
    const addDetails=()=>{
        ...
        axios({
            method: 'post',
            url: 'http://localhost:8000/savecar',
            headers: {
    ...
    const editDetails=()=>{
        ...
        axios({
            method: 'post',
            url: `http://localhost:8000/editCar?id=${carId}`,
            headers: {
                'Content-Type' : 'application/json'
            }, 
            data: JSON.stringify({
    ...
    const deleteDetails=()=>{
        ...
        axios({
            method: 'get',
            url: `http://localhost:8000/deleteCar?id=${carId}`
        }).then((response)=>{
            const newData = response.data.map(object => ({
                carId: object.carId,
                carModel: object.carModel,
    ...
    const findDetails=()=>{
        ...
        axios({
            method: 'get',
            url: `http://localhost:8000/getCar?id=${carId}`
        }).then((response)=>{
